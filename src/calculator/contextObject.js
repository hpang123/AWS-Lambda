...
exports.handler = (event, context, callback) => {
    ...
    case "yes":
         ...
         * default behavior of a callback() function, that is, to wait 
         * till the entire event loop is processed, and only then return back to the caller. 
         * If set to false, this property causes the callback() function to stop any further processing 
         * in the event loop even if there are any other tasks to be performed. 
